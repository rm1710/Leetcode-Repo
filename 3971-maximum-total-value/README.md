<h2><a href="https://leetcode.com/problems/maximum-total-value">4274. Maximum Total Value</a></h2><h3>Hard</h3><hr><p>You are given two integer arrays <code>value</code> and <code>decay</code>, and an integer <code>m</code>.</p>
...
<p>You may <strong>select</strong> any index multiple times. The total number of selections across all indices must not exceed <code>m</code>.</p>

<p>If you select index <code>i</code> for the <code>t<sup>th</sup></code> time (1-indexed), the value gained is <code>value[i] - decay[i] * (t - 1)</code>.</p>
